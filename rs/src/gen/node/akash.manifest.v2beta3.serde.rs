...
impl serde::Serialize for Group {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta3.Group", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Group {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.Group")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta3.Group", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ImageCredentials {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta3.ImageCredentials", len)?;
        if !self.host.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ImageCredentials {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.ImageCredentials")
            }
...
impl<'de> serde::Deserialize<'de> for Service {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.Service")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta3.Service", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ServiceExpose {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta3.ServiceExpose", len)?;
        if self.port != 0 {
...
impl<'de> serde::Deserialize<'de> for ServiceExpose {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.ServiceExpose")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta3.ServiceExpose", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for ServiceExposeHttpOptions {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.ServiceExposeHTTPOptions")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta3.ServiceExposeHTTPOptions", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for ServiceParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.ServiceParams")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta3.ServiceParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ServicePermissions {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta3.ServicePermissions", len)?;
        if !self.read.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ServicePermissions {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.ServicePermissions")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta3.ServicePermissions", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StorageParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta3.StorageParams", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.mount.is_empty() {
        ...
        if !self.key_ref.is_empty() {
            struct_ser.serialize_field("keyRef", &self.key_ref)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for StorageParams {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "keyRef" | "key_ref" => Ok(GeneratedField::KeyRef),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta3.StorageParams")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::KeyRef => {
                            if key_ref__.is_some() {
                                return Err(serde::de::Error::duplicate_field("keyRef"));
                            }
                            key_ref__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(StorageParams {
                    ...
                    key_ref: key_ref__.unwrap_or_default(),
                })
            }
        }
