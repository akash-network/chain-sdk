...
impl serde::Serialize for AttributesFilters {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.AttributesFilters", len)?;
        if !self.auditors.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AttributesFilters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.AttributesFilters")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.AttributesFilters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AuditedAttributesStore {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.AuditedAttributesStore", len)?;
        if !self.attributes.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AuditedAttributesStore {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.AuditedAttributesStore")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.AuditedAttributesStore", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AuditedProvider {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.AuditedProvider", len)?;
        if !self.owner.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AuditedProvider {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.AuditedProvider")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.AuditedProvider", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventTrustedAuditorCreated {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.EventTrustedAuditorCreated", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if !self.auditor.is_empty() {
...
impl<'de> serde::Deserialize<'de> for EventTrustedAuditorCreated {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.EventTrustedAuditorCreated")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.EventTrustedAuditorCreated", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventTrustedAuditorDeleted {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.EventTrustedAuditorDeleted", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if !self.auditor.is_empty() {
...
impl<'de> serde::Deserialize<'de> for EventTrustedAuditorDeleted {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.EventTrustedAuditorDeleted")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.EventTrustedAuditorDeleted", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.GenesisState", len)?;
        if !self.providers.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.GenesisState")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgDeleteProviderAttributes {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.MsgDeleteProviderAttributes", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if !self.auditor.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgDeleteProviderAttributes {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.MsgDeleteProviderAttributes")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.MsgDeleteProviderAttributes", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgDeleteProviderAttributesResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("akash.audit.v1.MsgDeleteProviderAttributesResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgDeleteProviderAttributesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.MsgDeleteProviderAttributesResponse")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.MsgDeleteProviderAttributesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgSignProviderAttributes {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.MsgSignProviderAttributes", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if !self.auditor.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgSignProviderAttributes {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.MsgSignProviderAttributes")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.MsgSignProviderAttributes", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgSignProviderAttributesResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("akash.audit.v1.MsgSignProviderAttributesResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgSignProviderAttributesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.MsgSignProviderAttributesResponse")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.MsgSignProviderAttributesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryAllProvidersAttributesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.QueryAllProvidersAttributesRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for QueryAllProvidersAttributesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.QueryAllProvidersAttributesRequest")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.QueryAllProvidersAttributesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryAuditorAttributesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.QueryAuditorAttributesRequest", len)?;
        if !self.auditor.is_empty() {
            struct_ser.serialize_field("auditor", &self.auditor)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryAuditorAttributesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.QueryAuditorAttributesRequest")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.QueryAuditorAttributesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryProviderAttributesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.QueryProviderAttributesRequest", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryProviderAttributesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.QueryProviderAttributesRequest")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.QueryProviderAttributesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryProviderAuditorRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.QueryProviderAuditorRequest", len)?;
        if !self.auditor.is_empty() {
            struct_ser.serialize_field("auditor", &self.auditor)?;
        }
        if !self.owner.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QueryProviderAuditorRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.QueryProviderAuditorRequest")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.QueryProviderAuditorRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryProviderRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.QueryProviderRequest", len)?;
        if !self.auditor.is_empty() {
            struct_ser.serialize_field("auditor", &self.auditor)?;
        }
        if !self.owner.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QueryProviderRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.QueryProviderRequest")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.QueryProviderRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryProvidersResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.audit.v1.QueryProvidersResponse", len)?;
        if !self.providers.is_empty() {
            struct_ser.serialize_field("providers", &self.providers)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryProvidersResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.audit.v1.QueryProvidersResponse")
            }
        ...
        deserializer.deserialize_struct("akash.audit.v1.QueryProvidersResponse", FIELDS, GeneratedVisitor)
    }
}
