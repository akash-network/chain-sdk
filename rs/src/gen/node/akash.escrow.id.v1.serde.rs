...
impl serde::Serialize for Account {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.id.v1.Account", len)?;
        if self.scope != 0 {
...
impl<'de> serde::Deserialize<'de> for Account {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.id.v1.Account")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.id.v1.Account", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Payment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.id.v1.Payment", len)?;
...
impl<'de> serde::Deserialize<'de> for Payment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.id.v1.Payment")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.id.v1.Payment", FIELDS, GeneratedVisitor)
    }
}
