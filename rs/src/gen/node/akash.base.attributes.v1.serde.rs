...
impl serde::Serialize for Attribute {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.attributes.v1.Attribute", len)?;
        if !self.key.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Attribute {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.attributes.v1.Attribute")
            }
        ...
        deserializer.deserialize_struct("akash.base.attributes.v1.Attribute", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for PlacementRequirements {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.attributes.v1.PlacementRequirements")
            }
        ...
        deserializer.deserialize_struct("akash.base.attributes.v1.PlacementRequirements", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SignedBy {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.attributes.v1.SignedBy", len)?;
        if !self.all_of.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SignedBy {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.attributes.v1.SignedBy")
            }
        ...
        deserializer.deserialize_struct("akash.base.attributes.v1.SignedBy", FIELDS, GeneratedVisitor)
    }
}
