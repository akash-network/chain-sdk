...
impl serde::Serialize for MsgSignData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.offchain.sign.v1.MsgSignData", len)?;
        if !self.signer.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgSignData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.offchain.sign.v1.MsgSignData")
            }
        ...
        deserializer.deserialize_struct("akash.base.offchain.sign.v1.MsgSignData", FIELDS, GeneratedVisitor)
    }
}
