...
impl serde::Serialize for Certificate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.Certificate", len)?;
        if self.state != 0 {
...
impl<'de> serde::Deserialize<'de> for Certificate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.Certificate")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.Certificate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CertificateFilter {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.CertificateFilter", len)?;
        if !self.owner.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CertificateFilter {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.CertificateFilter")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.CertificateFilter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CertificateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.CertificateResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for CertificateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.CertificateResponse")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.CertificateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisCertificate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.GenesisCertificate", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if let Some(v) = self.certificate.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GenesisCertificate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.GenesisCertificate")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.GenesisCertificate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.GenesisState", len)?;
        if !self.certificates.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.GenesisState")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Id {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.ID", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if !self.serial.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Id {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.ID")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.ID", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgCreateCertificate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.MsgCreateCertificate", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if !self.cert.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgCreateCertificate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.MsgCreateCertificate")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.MsgCreateCertificate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgCreateCertificateResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("akash.cert.v1.MsgCreateCertificateResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgCreateCertificateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.MsgCreateCertificateResponse")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.MsgCreateCertificateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgRevokeCertificate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.MsgRevokeCertificate", len)?;
...
impl<'de> serde::Deserialize<'de> for MsgRevokeCertificate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.MsgRevokeCertificate")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.MsgRevokeCertificate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgRevokeCertificateResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("akash.cert.v1.MsgRevokeCertificateResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgRevokeCertificateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.MsgRevokeCertificateResponse")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.MsgRevokeCertificateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCertificatesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.QueryCertificatesRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for QueryCertificatesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.QueryCertificatesRequest")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.QueryCertificatesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCertificatesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.cert.v1.QueryCertificatesResponse", len)?;
        if !self.certificates.is_empty() {
            struct_ser.serialize_field("certificates", &self.certificates)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryCertificatesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.cert.v1.QueryCertificatesResponse")
            }
        ...
        deserializer.deserialize_struct("akash.cert.v1.QueryCertificatesResponse", FIELDS, GeneratedVisitor)
    }
}
