...
impl serde::Serialize for BidEngineStatus {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.provider.v1.BidEngineStatus", len)?;
        if self.orders != 0 {
...
impl<'de> serde::Deserialize<'de> for BidEngineStatus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.BidEngineStatus")
            }
...
impl serde::Serialize for ClusterStatus {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.provider.v1.ClusterStatus", len)?;
...
impl<'de> serde::Deserialize<'de> for ClusterStatus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.ClusterStatus")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.ClusterStatus", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for Inventory {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.Inventory")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.Inventory", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Leases {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.provider.v1.Leases", len)?;
        if self.active != 0 {
...
impl<'de> serde::Deserialize<'de> for Leases {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.Leases")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.Leases", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ManifestStatus {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.provider.v1.ManifestStatus", len)?;
        if self.deployments != 0 {
...
impl<'de> serde::Deserialize<'de> for ManifestStatus {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.ManifestStatus")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.ManifestStatus", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Reservations {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.provider.v1.Reservations", len)?;
...
impl<'de> serde::Deserialize<'de> for Reservations {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.Reservations")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.Reservations", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ReservationsMetric {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.provider.v1.ReservationsMetric", len)?;
        if self.count != 0 {
...
impl<'de> serde::Deserialize<'de> for ReservationsMetric {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.ReservationsMetric")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.ReservationsMetric", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResourcesMetric {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.provider.v1.ResourcesMetric", len)?;
...
impl<'de> serde::Deserialize<'de> for ResourcesMetric {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.ResourcesMetric")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.ResourcesMetric", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for Status {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.provider.v1.Status")
            }
        ...
        deserializer.deserialize_struct("akash.provider.v1.Status", FIELDS, GeneratedVisitor)
    }
}
