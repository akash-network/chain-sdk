...
impl serde::Serialize for GenesisDowntimeEntry {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.downtimedetector.v1beta1.GenesisDowntimeEntry", len)?;
        if self.duration != 0 {
...
impl<'de> serde::Deserialize<'de> for GenesisDowntimeEntry {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.downtimedetector.v1beta1.GenesisDowntimeEntry")
            }
        ...
        deserializer.deserialize_struct("akash.downtimedetector.v1beta1.GenesisDowntimeEntry", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.downtimedetector.v1beta1.GenesisState", len)?;
        if !self.downtimes.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.downtimedetector.v1beta1.GenesisState")
            }
        ...
        deserializer.deserialize_struct("akash.downtimedetector.v1beta1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RecoveredSinceDowntimeOfLengthRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest", len)?;
        if self.downtime != 0 {
...
impl<'de> serde::Deserialize<'de> for RecoveredSinceDowntimeOfLengthRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest")
            }
        ...
        deserializer.deserialize_struct("akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for RecoveredSinceDowntimeOfLengthResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse", len)?;
        if self.succesfully_recovered {
...
impl<'de> serde::Deserialize<'de> for RecoveredSinceDowntimeOfLengthResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse")
            }
        ...
        deserializer.deserialize_struct("akash.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse", FIELDS, GeneratedVisitor)
    }
}
