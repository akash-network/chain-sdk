...
impl<'de> serde::Deserialize<'de> for EpochInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.EpochInfo")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.EpochInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventEpochEnd {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.epochs.v1beta1.EventEpochEnd", len)?;
        if self.epoch_number != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for EventEpochEnd {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.EventEpochEnd")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.EventEpochEnd", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventEpochStart {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.epochs.v1beta1.EventEpochStart", len)?;
        if self.epoch_number != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epochNumber", ToString::to_string(&self.epoch_number).as_str())?;
...
impl<'de> serde::Deserialize<'de> for EventEpochStart {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.EventEpochStart")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.EventEpochStart", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.epochs.v1beta1.GenesisState", len)?;
        if !self.epochs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.GenesisState")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCurrentEpochRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.epochs.v1beta1.QueryCurrentEpochRequest", len)?;
        if !self.identifier.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QueryCurrentEpochRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.QueryCurrentEpochRequest")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.QueryCurrentEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryCurrentEpochResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.epochs.v1beta1.QueryCurrentEpochResponse", len)?;
        if self.current_epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("currentEpoch", ToString::to_string(&self.current_epoch).as_str())?;
...
impl<'de> serde::Deserialize<'de> for QueryCurrentEpochResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.QueryCurrentEpochResponse")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.QueryCurrentEpochResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryEpochInfosRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("akash.epochs.v1beta1.QueryEpochInfosRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for QueryEpochInfosRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.QueryEpochInfosRequest")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.QueryEpochInfosRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryEpochInfosResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.epochs.v1beta1.QueryEpochInfosResponse", len)?;
        if !self.epochs.is_empty() {
            struct_ser.serialize_field("epochs", &self.epochs)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for QueryEpochInfosResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.epochs.v1beta1.QueryEpochInfosResponse")
            }
        ...
        deserializer.deserialize_struct("akash.epochs.v1beta1.QueryEpochInfosResponse", FIELDS, GeneratedVisitor)
    }
}
