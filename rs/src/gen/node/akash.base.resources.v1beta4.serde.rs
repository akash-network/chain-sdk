...
impl serde::Serialize for Cpu {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.resources.v1beta4.CPU", len)?;
...
impl<'de> serde::Deserialize<'de> for Cpu {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.resources.v1beta4.CPU")
            }
        ...
        deserializer.deserialize_struct("akash.base.resources.v1beta4.CPU", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Endpoint {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.resources.v1beta4.Endpoint", len)?;
        if self.kind != 0 {
...
impl<'de> serde::Deserialize<'de> for Endpoint {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.resources.v1beta4.Endpoint")
            }
        ...
        deserializer.deserialize_struct("akash.base.resources.v1beta4.Endpoint", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Gpu {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.resources.v1beta4.GPU", len)?;
        if let Some(v) = self.units.as_ref() {
            struct_ser.serialize_field("units", v)?;
        }
        if !self.attributes.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Gpu {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.resources.v1beta4.GPU")
            }
        ...
        deserializer.deserialize_struct("akash.base.resources.v1beta4.GPU", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Memory {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.resources.v1beta4.Memory", len)?;
...
impl<'de> serde::Deserialize<'de> for Memory {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.resources.v1beta4.Memory")
            }
        ...
        deserializer.deserialize_struct("akash.base.resources.v1beta4.Memory", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResourceValue {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.resources.v1beta4.ResourceValue", len)?;
        if !self.val.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ResourceValue {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.resources.v1beta4.ResourceValue")
            }
        ...
        deserializer.deserialize_struct("akash.base.resources.v1beta4.ResourceValue", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Resources {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.resources.v1beta4.Resources", len)?;
        if self.id != 0 {
...
impl<'de> serde::Deserialize<'de> for Resources {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.resources.v1beta4.Resources")
            }
        ...
        deserializer.deserialize_struct("akash.base.resources.v1beta4.Resources", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Storage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.base.resources.v1beta4.Storage", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Storage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.base.resources.v1beta4.Storage")
            }
        ...
        deserializer.deserialize_struct("akash.base.resources.v1beta4.Storage", FIELDS, GeneratedVisitor)
    }
}
