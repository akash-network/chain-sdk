...
impl serde::Serialize for Account {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.types.v1.Account", len)?;
...
impl<'de> serde::Deserialize<'de> for Account {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.types.v1.Account")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.types.v1.Account", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AccountState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.types.v1.AccountState", len)?;
        if !self.owner.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AccountState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.types.v1.AccountState")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.types.v1.AccountState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Balance {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.types.v1.Balance", len)?;
        if !self.denom.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Balance {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.types.v1.Balance")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.types.v1.Balance", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for Depositor {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.types.v1.Depositor")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.types.v1.Depositor", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Payment {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.types.v1.Payment", len)?;
        if let Some(v) = self.id.as_ref() {
            struct_ser.serialize_field("id", v)?;
        }
        if let Some(v) = self.state.as_ref() {
...
impl<'de> serde::Deserialize<'de> for Payment {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.types.v1.Payment")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.types.v1.Payment", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PaymentState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.types.v1.PaymentState", len)?;
        if !self.owner.is_empty() {
            struct_ser.serialize_field("owner", &self.owner)?;
        }
        if self.state != 0 {
...
impl<'de> serde::Deserialize<'de> for PaymentState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.types.v1.PaymentState")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.types.v1.PaymentState", FIELDS, GeneratedVisitor)
    }
}
