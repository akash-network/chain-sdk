...
The attestation field controls whether the provider injects an attestation sidecar.
 ...
 | Field | Type | Label | Description |
 | ----- | ---- | ----- | ----------- |
 | `type` | [string](#string) |  | type is the TEE technology: sev-snp, sev-snp-gpu, tdx, tdx-gpu |
...
The provider never inspects or modifies any field.
 ...
 | `tee_type` | [string](#string) |  | TEE type identifier: "snp", "tdx", "snp-gpu", "tdx-gpu". |
 ...
 | `AttestationQuote` | [AttestationQuoteRequest](#akash.provider.lease.v1.AttestationQuoteRequest) | [AttestationQuoteResponse](#akash.provider.lease.v1.AttestationQuoteResponse) | AttestationQuote requests hardware-signed attestation evidence from the confidential compute sidecar. The provider forwards the tenant's nonce to the sidecar and returns the hardware-signed quote verbatim. | |
