      ...
      if (data95 && typeof data95 == "object" && !Array.isArray(data95)) {
        ...
        if (data95.min_window !== void 0) {
          ...
          if (typeof data96 === "string") {
            if (func2(data96) < 1) {
              const err222 = { instancePath: instancePath + "/reclamation/min_window", schemaPath: "#/properties/reclamation/properties/min_window/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
              if (vErrors === null) {
                vErrors = [err222];
              } else {
                vErrors.push(err222);
