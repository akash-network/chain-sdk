...
function createBaseEventAttestationSubmitted(): EventAttestationSubmitted {
  return { provider: "", auditor: "", tier: 0, capabilities: [], expiresAt: undefined, auditEscrowId: 0n };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.oldAuditEscrowId = reader.uint64() as bigint;
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.newAuditEscrowId = reader.uint64() as bigint;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseEventAuditEscrowOpened(): EventAuditEscrowOpened {
  return { auditEscrowId: 0n, provider: "", fee: undefined, providerDeposit: undefined };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.graceRecordId = reader.uint64() as bigint;
          continue;
        }
        case 2: {
          if (tag !== 18) {
