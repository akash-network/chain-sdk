...
export const EpochInfo: MessageFns<EpochInfo, "akash.epochs.v1beta1.EpochInfo"> = {
  $type: "akash.epochs.v1beta1.EpochInfo" as const,
  ...
  fromJSON(object: any): EpochInfo {
    return {
      ...
      currentEpoch: isSet(object.current_epoch) ? BigInt(object.current_epoch) : 0n,
  ...
  toJSON(message: EpochInfo): unknown {
    ...
    if (message.currentEpoch !== 0n) {
      obj.current_epoch = message.currentEpoch.toString();
    }
    if (message.currentEpochStartTime !== undefined) {
    ...
    if (message.currentEpochStartHeight !== 0n) {
      obj.current_epoch_start_height = message.currentEpochStartHeight.toString();
    }
    return obj;
  },
  fromPartial(object: DeepPartial<EpochInfo>): EpochInfo {
    ...
    message.duration = (object.duration !== undefined && object.duration !== null)
      ...
      : undefined;
    message.currentEpoch = (object.currentEpoch !== undefined && object.currentEpoch !== null) ? BigInt(object.currentEpoch) : 0n;
    message.currentEpochStartTime = object.currentEpochStartTime ?? undefined;
    message.epochCountingStarted = object.epochCountingStarted ?? false;
    message.currentEpochStartHeight = (object.currentEpochStartHeight !== undefined && object.currentEpochStartHeight !== null) ? BigInt(object.currentEpochStartHeight) : 0n;
    return message;
  },
};
...
export const GenesisState: MessageFns<GenesisState, "akash.epochs.v1beta1.GenesisState"> = {
  $type: "akash.epochs.v1beta1.GenesisState" as const,
