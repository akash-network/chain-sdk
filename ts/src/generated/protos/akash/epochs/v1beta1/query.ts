...
//   protoc               unknown
// source: akash/epochs/v1beta1/query.proto
...
export const QueryEpochInfosRequest: MessageFns<QueryEpochInfosRequest, "akash.epochs.v1beta1.QueryEpochInfosRequest"> =
  {
    $type: "akash.epochs.v1beta1.QueryEpochInfosRequest" as const,
...
> = {
  $type: "akash.epochs.v1beta1.QueryEpochInfosResponse" as const,
...
> = {
  $type: "akash.epochs.v1beta1.QueryCurrentEpochRequest" as const,
...
> = {
  $type: "akash.epochs.v1beta1.QueryCurrentEpochResponse" as const,
  ...
  fromJSON(object: any): QueryCurrentEpochResponse {
    return { currentEpoch: isSet(object.current_epoch) ? BigInt(object.current_epoch) : 0n };
  },
