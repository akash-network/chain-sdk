...
const _CollateralRatio: MessageFns<CollateralRatio, "akash.bme.v1.CollateralRatio"> = {
  $type: "akash.bme.v1.CollateralRatio" as const,
...
export const State: MessageFns<State, "akash.bme.v1.State"> = {
  $type: "akash.bme.v1.State" as const,
...
const _CoinPrice: MessageFns<CoinPrice, "akash.bme.v1.CoinPrice"> = {
  $type: "akash.bme.v1.CoinPrice" as const,
...
export const BurnMintPair: MessageFns<BurnMintPair, "akash.bme.v1.BurnMintPair"> = {
  $type: "akash.bme.v1.BurnMintPair" as const,
...
export const LedgerRecordID: MessageFns<LedgerRecordID, "akash.bme.v1.LedgerRecordID"> = {
  $type: "akash.bme.v1.LedgerRecordID" as const,
...
export const LedgerPendingRecord: MessageFns<LedgerPendingRecord, "akash.bme.v1.LedgerPendingRecord"> = {
  $type: "akash.bme.v1.LedgerPendingRecord" as const,
...
export const LedgerRecord: MessageFns<LedgerRecord, "akash.bme.v1.LedgerRecord"> = {
  $type: "akash.bme.v1.LedgerRecord" as const,
...
export const Status: MessageFns<Status, "akash.bme.v1.Status"> = {
  $type: "akash.bme.v1.Status" as const,
  ...
  fromPartial(object: DeepPartial<Status>): Status {
    ...
    message.epochHeightDiff = object.epochHeightDiff ?? 0n;
    return message;
  },
};
