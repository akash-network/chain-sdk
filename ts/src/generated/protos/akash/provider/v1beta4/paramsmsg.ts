...
export const MsgUpdateParams: MessageFns<MsgUpdateParams, "akash.provider.v1beta4.MsgUpdateParams"> = {
  $type: "akash.provider.v1beta4.MsgUpdateParams" as const,
...
export const MsgUpdateParamsResponse: MessageFns<
  ...
  "akash.provider.v1beta4.MsgUpdateParamsResponse"
> = {
  $type: "akash.provider.v1beta4.MsgUpdateParamsResponse" as const,
