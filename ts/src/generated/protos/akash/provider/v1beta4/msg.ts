...
> = {
  ...
  encode(message: MsgOpenProviderMaintenanceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.maintenanceId !== 0n) {
      if (BigInt.asUintN(64, message.maintenanceId) !== message.maintenanceId) {
        throw new globalThis.Error("value provided for field message.maintenanceId of type uint64 too large");
      }
      writer.uint32(8).uint64(message.maintenanceId);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.maintenanceId = reader.uint64() as bigint;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): MsgOpenProviderMaintenanceResponse {
    return { maintenanceId: isSet(object.maintenance_id) ? BigInt(object.maintenance_id) : 0n };
  },

  toJSON(message: MsgOpenProviderMaintenanceResponse): unknown {
    const obj: any = {};
    if (message.maintenanceId !== 0n) {
      obj.maintenance_id = message.maintenanceId.toString();
    }
    return obj;
  },
...
function createBaseMsgCloseProviderMaintenance(): MsgCloseProviderMaintenance {
  return { provider: "", maintenanceId: 0n };
}
...
> = {
  ...
  encode(message: MsgCloseProviderMaintenance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.maintenanceId !== 0n) {
      ...
      writer.uint32(16).uint64(message.maintenanceId);
    }
    return writer;
  },
  ...
  fromJSON(object: any): MsgCloseProviderMaintenance {
    return {
      provider: isSet(object.provider) ? globalThis.String(object.provider) : "",
      maintenanceId: isSet(object.maintenance_id) ? BigInt(object.maintenance_id) : 0n,
    };
  },
