...
import { PriceData, PriceDataID } from "./prices.ts";
...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, prices: [], latestHeight: [] };
}

export const GenesisState: MessageFns<GenesisState, "akash.oracle.v1.GenesisState"> = {
  $type: "akash.oracle.v1.GenesisState" as const,
  ...
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.latestHeight) {
      PriceDataID.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      latestHeight: globalThis.Array.isArray(object?.latest_height)
        ? object.latest_height.map((e: any) => PriceDataID.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.latestHeight?.length) {
      obj.latest_height = message.latestHeight.map((e) => PriceDataID.toJSON(e));
    }
    return obj;
  },
