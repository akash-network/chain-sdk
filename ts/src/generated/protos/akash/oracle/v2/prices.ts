...
function createBasePriceLatestDataState(): PriceLatestDataState {
  return { timestamp: undefined, sequence: 0n };
}
...
function createBasePriceDataRecordID(): PriceDataRecordID {
  return { source: 0, denom: "", baseDenom: "", timestamp: undefined, sequence: 0n };
}
...
const _AggregatedPrice: MessageFns<AggregatedPrice, "akash.oracle.v2.AggregatedPrice"> = {
  ...
  encode(message: AggregatedPrice, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.deviationBps !== 0n) {
      if (BigInt.asUintN(64, message.deviationBps) !== message.deviationBps) {
        throw new globalThis.Error("value provided for field message.deviationBps of type uint64 too large");
      }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.deviationBps = reader.uint64() as bigint;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): AggregatedPrice {
    return {
      ...
      deviationBps: isSet(object.deviation_bps) ? BigInt(object.deviation_bps) : 0n,
    };
  },
  ...
  toJSON(message: AggregatedPrice): unknown {
    ...
    if (message.deviationBps !== 0n) {
      obj.deviation_bps = message.deviationBps.toString();
    }
    return obj;
  },
  fromPartial(object: DeepPartial<AggregatedPrice>): AggregatedPrice {
    ...
    message.deviationBps = (object.deviationBps !== undefined && object.deviationBps !== null) ? BigInt(object.deviationBps) : 0n;
    return message;
  },
};
