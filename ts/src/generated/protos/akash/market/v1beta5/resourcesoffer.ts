...
export const StorageOfferPrice: MessageFns<StorageOfferPrice, "akash.market.v1beta5.StorageOfferPrice"> = {
  ...
  create(base?: DeepPartial<StorageOfferPrice>): StorageOfferPrice {
    return StorageOfferPrice.fromPartial(base ?? {});
  },
...
export const EndpointOfferPrice: MessageFns<EndpointOfferPrice, "akash.market.v1beta5.EndpointOfferPrice"> = {
  ...
  create(base?: DeepPartial<EndpointOfferPrice>): EndpointOfferPrice {
    return EndpointOfferPrice.fromPartial(base ?? {});
  },
...
export const OfferPrices: MessageFns<OfferPrices, "akash.market.v1beta5.OfferPrices"> = {
  ...
  create(base?: DeepPartial<OfferPrices>): OfferPrices {
    return OfferPrices.fromPartial(base ?? {});
  },
