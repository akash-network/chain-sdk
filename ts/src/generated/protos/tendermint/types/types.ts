...
import { BlockIDFlag, blockIDFlagFromJSON, blockIDFlagToJSON, ValidatorSet } from "./validator.ts";
...
export const BlockMeta: MessageFns<BlockMeta, "tendermint.types.BlockMeta"> = {
  ...
  fromJSON(object: any): BlockMeta {
    return {
      blockId: isSet(object.block_id) ? BlockID.fromJSON(object.block_id) : undefined,
      blockSize: isSet(object.block_size) ? BigInt(object.block_size) : 0n,
      header: isSet(object.header) ? Header.fromJSON(object.header) : undefined,
      numTxs: isSet(object.num_txs) ? BigInt(object.num_txs) : 0n,
    };
  },
  ...
  toJSON(message: BlockMeta): unknown {
    ...
    if (message.blockSize !== 0n) {
      obj.block_size = message.blockSize.toString();
    }
    if (message.header !== undefined) {
      obj.header = Header.toJSON(message.header);
    }
    if (message.numTxs !== 0n) {
      obj.num_txs = message.numTxs.toString();
    }
    return obj;
  },
  fromPartial(object: DeepPartial<BlockMeta>): BlockMeta {
    ...
    message.blockId = (object.blockId !== undefined && object.blockId !== null)
      ? BlockID.fromPartial(object.blockId)
      : undefined;
    message.blockSize = (object.blockSize !== undefined && object.blockSize !== null) ? BigInt(object.blockSize) : 0n;
    message.header = (object.header !== undefined && object.header !== null)
      ? Header.fromPartial(object.header)
      : undefined;
