...
export const GenesisState: MessageFns<GenesisState, "ibc.core.channel.v2.GenesisState"> = {
  $type: "ibc.core.channel.v2.GenesisState" as const,
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      receipts: globalThis.Array.isArray(object?.receipts)
        ...
        : [],
      asyncPackets: globalThis.Array.isArray(object?.async_packets)
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.asyncPackets?.length) {
      obj.async_packets = message.asyncPackets.map((e) => PacketState.toJSON(e));
    }
...
export const PacketState: MessageFns<PacketState, "ibc.core.channel.v2.PacketState"> = {
  $type: "ibc.core.channel.v2.PacketState" as const,
...
export const PacketSequence: MessageFns<PacketSequence, "ibc.core.channel.v2.PacketSequence"> = {
  $type: "ibc.core.channel.v2.PacketSequence" as const,
