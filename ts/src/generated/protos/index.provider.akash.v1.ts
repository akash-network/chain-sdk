...
export { SnapshotPayload, SnapshotResourceSummary, SnapshotEvidenceSection, GetInventorySnapshotRequest, GetInventorySnapshotResponse } from "./akash/inventory/v1/snapshot.ts";
