...
export const ConfigRequest: MessageFns<ConfigRequest, "cosmos.base.node.v1beta1.ConfigRequest"> = {
...
export const ConfigResponse: MessageFns<ConfigResponse, "cosmos.base.node.v1beta1.ConfigResponse"> = {
  ...
  fromJSON(object: any): ConfigResponse {
    return {
      ...
      haltHeight: isSet(object.halt_height) ? BigInt(object.halt_height) : 0n,
    };
  },
  ...
  toJSON(message: ConfigResponse): unknown {
    ...
    if (message.haltHeight !== 0n) {
      obj.halt_height = message.haltHeight.toString();
    }
    return obj;
  },
  fromPartial(object: DeepPartial<ConfigResponse>): ConfigResponse {
    ...
    message.haltHeight = (object.haltHeight !== undefined && object.haltHeight !== null) ? BigInt(object.haltHeight) : 0n;
    return message;
  },
};
...
export const StatusRequest: MessageFns<StatusRequest, "cosmos.base.node.v1beta1.StatusRequest"> = {
...
export const StatusResponse: MessageFns<StatusResponse, "cosmos.base.node.v1beta1.StatusResponse"> = {
  ...
  fromJSON(object: any): StatusResponse {
    return {
      earliestStoreHeight: isSet(object.earliest_store_height) ? BigInt(object.earliest_store_height) : 0n,
  ...
  toJSON(message: StatusResponse): unknown {
    const obj: any = {};
    if (message.earliestStoreHeight !== 0n) {
      obj.earliest_store_height = message.earliestStoreHeight.toString();
    }
    if (message.height !== 0n) {
  ...
  fromPartial(object: DeepPartial<StatusResponse>): StatusResponse {
    const message = createBaseStatusResponse();
    message.earliestStoreHeight = (object.earliestStoreHeight !== undefined && object.earliestStoreHeight !== null) ? BigInt(object.earliestStoreHeight) : 0n;
