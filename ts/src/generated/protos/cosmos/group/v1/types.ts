...
export const Proposal: MessageFns<Proposal, "cosmos.group.v1.Proposal"> = {
  ...
  encode(message: Proposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.groupVersion !== 0n) {
      if (BigInt.asUintN(64, message.groupVersion) !== message.groupVersion) {
        throw new globalThis.Error("value provided for field message.groupVersion of type uint64 too large");
      }
      writer.uint32(48).uint64(message.groupVersion);
    }
    if (message.groupPolicyVersion !== 0n) {
      if (BigInt.asUintN(64, message.groupPolicyVersion) !== message.groupPolicyVersion) {
        throw new globalThis.Error("value provided for field message.groupPolicyVersion of type uint64 too large");
      }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.groupVersion = reader.uint64() as bigint;
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.groupPolicyVersion = reader.uint64() as bigint;
          continue;
        }
        case 8: {
          if (tag !== 64) {
  ...
  fromJSON(object: any): Proposal {
    return {
      ...
      groupVersion: isSet(object.group_version) ? BigInt(object.group_version) : 0n,
      groupPolicyVersion: isSet(object.group_policy_version) ? BigInt(object.group_policy_version) : 0n,
  ...
  toJSON(message: Proposal): unknown {
    ...
    if (message.groupVersion !== 0n) {
      obj.group_version = message.groupVersion.toString();
    }
    if (message.groupPolicyVersion !== 0n) {
      obj.group_policy_version = message.groupPolicyVersion.toString();
    }
    if (message.status !== 0) {
  ...
  fromPartial(object: DeepPartial<Proposal>): Proposal {
    ...
    message.groupVersion = (object.groupVersion !== undefined && object.groupVersion !== null) ? BigInt(object.groupVersion) : 0n;
    message.groupPolicyVersion = (object.groupPolicyVersion !== undefined && object.groupPolicyVersion !== null) ? BigInt(object.groupPolicyVersion) : 0n;
