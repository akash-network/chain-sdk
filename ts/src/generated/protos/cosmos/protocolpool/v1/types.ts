...
const _ContinuousFund: MessageFns<ContinuousFund, "cosmos.protocolpool.v1.ContinuousFund"> = {
...
export const Params: MessageFns<Params, "cosmos.protocolpool.v1.Params"> = {
  ...
  fromJSON(object: any): Params {
    return {
      enabledDistributionDenoms: globalThis.Array.isArray(object?.enabled_distribution_denoms)
        ...
        : [],
      distributionFrequency: isSet(object.distribution_frequency) ? BigInt(object.distribution_frequency) : 0n,
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.distributionFrequency !== 0n) {
      obj.distribution_frequency = message.distributionFrequency.toString();
    }
    return obj;
  },
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    message.distributionFrequency = (object.distributionFrequency !== undefined && object.distributionFrequency !== null) ? BigInt(object.distributionFrequency) : 0n;
    return message;
  },
};
