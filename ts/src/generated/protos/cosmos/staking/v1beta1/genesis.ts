...
/** _GenesisStateWire defines the staking module's genesis state. */
interface _GenesisStateWire {
...
function createBaseGenesisState(): _GenesisStateWire {
  return {
    params: undefined,
...
const _GenesisState: MessageFns<_GenesisStateWire, "cosmos.staking.v1beta1.GenesisState"> = {
  $type: "cosmos.staking.v1beta1.GenesisState" as const,

  encode(message: _GenesisStateWire, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): _GenesisStateWire {
  ...
  fromJSON(object: any): _GenesisStateWire {
    return {
  ...
  toJSON(message: _GenesisStateWire): unknown {
    const obj: any = {};
    if (message.params !== undefined) {
  ...
  fromPartial(object: DeepPartial<_GenesisStateWire>): _GenesisStateWire {
    const message = createBaseGenesisState();
...
export type GenesisState = Omit<_GenesisStateWire, "lastTotalPower"> & { lastTotalPower: bigint };
export const GenesisState = patched(_GenesisState) as unknown as MessageFns<GenesisState, "cosmos.staking.v1beta1.GenesisState">;
