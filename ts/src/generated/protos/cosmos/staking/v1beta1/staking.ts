...
const _CommissionRates: MessageFns<CommissionRates, "cosmos.staking.v1beta1.CommissionRates"> = {
...
const _Validator: MessageFns<Validator, "cosmos.staking.v1beta1.Validator"> = {
  ...
  toJSON(message: Validator): unknown {
    ...
    if (message.unbondingHeight !== 0n) {
      obj.unbonding_height = message.unbondingHeight.toString();
    }
    if (message.unbondingTime !== undefined) {
    ...
    if (message.unbondingOnHoldRefCount !== 0n) {
      obj.unbonding_on_hold_ref_count = message.unbondingOnHoldRefCount.toString();
    }
  ...
  fromPartial(object: DeepPartial<Validator>): Validator {
    ...
    message.description = (object.description !== undefined && object.description !== null)
      ...
      : undefined;
    message.unbondingHeight = (object.unbondingHeight !== undefined && object.unbondingHeight !== null) ? BigInt(object.unbondingHeight) : 0n;
    message.unbondingTime = object.unbondingTime ?? undefined;
    message.commission = (object.commission !== undefined && object.commission !== null)
      ? Commission.fromPartial(object.commission)
      : undefined;
    message.minSelfDelegation = object.minSelfDelegation ?? "";
    message.unbondingOnHoldRefCount = (object.unbondingOnHoldRefCount !== undefined && object.unbondingOnHoldRefCount !== null) ? BigInt(object.unbondingOnHoldRefCount) : 0n;
    message.unbondingIds = object.unbondingIds?.map((e) => BigInt(e)) || [];
    return message;
  },
};
...
const _Delegation: MessageFns<Delegation, "cosmos.staking.v1beta1.Delegation"> = {
...
> = {
  ...
  fromJSON(object: any): UnbondingDelegationEntry {
    return {
      creationHeight: isSet(object.creation_height) ? BigInt(object.creation_height) : 0n,
      ...
      unbondingId: isSet(object.unbonding_id) ? BigInt(object.unbonding_id) : 0n,
      unbondingOnHoldRefCount: isSet(object.unbonding_on_hold_ref_count)
        ? BigInt(object.unbonding_on_hold_ref_count)
        : 0n,
    };
  ...
  toJSON(message: UnbondingDelegationEntry): unknown {
    const obj: any = {};
    if (message.creationHeight !== 0n) {
      obj.creation_height = message.creationHeight.toString();
    }
    if (message.completionTime !== undefined) {
    ...
    if (message.unbondingId !== 0n) {
      obj.unbonding_id = message.unbondingId.toString();
    }
    if (message.unbondingOnHoldRefCount !== 0n) {
      obj.unbonding_on_hold_ref_count = message.unbondingOnHoldRefCount.toString();
    }
  ...
  fromPartial(object: DeepPartial<UnbondingDelegationEntry>): UnbondingDelegationEntry {
    const message = createBaseUnbondingDelegationEntry();
    message.creationHeight = (object.creationHeight !== undefined && object.creationHeight !== null) ? BigInt(object.creationHeight) : 0n;
    message.completionTime = object.completionTime ?? undefined;
    message.initialBalance = object.initialBalance ?? "";
    message.balance = object.balance ?? "";
    message.unbondingId = (object.unbondingId !== undefined && object.unbondingId !== null) ? BigInt(object.unbondingId) : 0n;
    message.unbondingOnHoldRefCount = (object.unbondingOnHoldRefCount !== undefined && object.unbondingOnHoldRefCount !== null) ? BigInt(object.unbondingOnHoldRefCount) : 0n;
    return message;
  },
};
...
const _RedelegationEntry: MessageFns<RedelegationEntry, "cosmos.staking.v1beta1.RedelegationEntry"> = {
...
const _Params: MessageFns<Params, "cosmos.staking.v1beta1.Params"> = {
...
export const Validator = patched(_Validator);
