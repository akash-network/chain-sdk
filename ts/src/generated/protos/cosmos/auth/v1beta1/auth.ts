...
export const BaseAccount: MessageFns<BaseAccount, "cosmos.auth.v1beta1.BaseAccount"> = {
  ...
  fromJSON(object: any): BaseAccount {
    return {
      ...
      accountNumber: isSet(object.account_number) ? BigInt(object.account_number) : 0n,
  ...
  toJSON(message: BaseAccount): unknown {
    ...
    if (message.accountNumber !== 0n) {
      obj.account_number = message.accountNumber.toString();
    }
    if (message.sequence !== 0n) {
  ...
  fromPartial(object: DeepPartial<BaseAccount>): BaseAccount {
    ...
    message.pubKey = (object.pubKey !== undefined && object.pubKey !== null)
      ...
      : undefined;
    message.accountNumber = (object.accountNumber !== undefined && object.accountNumber !== null) ? BigInt(object.accountNumber) : 0n;
...
export const Params: MessageFns<Params, "cosmos.auth.v1beta1.Params"> = {
  ...
  fromJSON(object: any): Params {
    return {
      maxMemoCharacters: isSet(object.max_memo_characters) ? BigInt(object.max_memo_characters) : 0n,
      txSigLimit: isSet(object.tx_sig_limit) ? BigInt(object.tx_sig_limit) : 0n,
      txSizeCostPerByte: isSet(object.tx_size_cost_per_byte) ? BigInt(object.tx_size_cost_per_byte) : 0n,
      sigVerifyCostEd25519: isSet(object.sig_verify_cost_ed25519) ? BigInt(object.sig_verify_cost_ed25519) : 0n,
      sigVerifyCostSecp256k1: isSet(object.sig_verify_cost_secp256k1) ? BigInt(object.sig_verify_cost_secp256k1) : 0n,
    };
  },
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    if (message.maxMemoCharacters !== 0n) {
      obj.max_memo_characters = message.maxMemoCharacters.toString();
    }
    if (message.txSigLimit !== 0n) {
      obj.tx_sig_limit = message.txSigLimit.toString();
    }
    if (message.txSizeCostPerByte !== 0n) {
      obj.tx_size_cost_per_byte = message.txSizeCostPerByte.toString();
    }
    if (message.sigVerifyCostEd25519 !== 0n) {
      obj.sig_verify_cost_ed25519 = message.sigVerifyCostEd25519.toString();
    }
    if (message.sigVerifyCostSecp256k1 !== 0n) {
      obj.sig_verify_cost_secp256k1 = message.sigVerifyCostSecp256k1.toString();
    }
    return obj;
  },
  fromPartial(object: DeepPartial<Params>): Params {
    const message = createBaseParams();
    message.maxMemoCharacters = (object.maxMemoCharacters !== undefined && object.maxMemoCharacters !== null) ? BigInt(object.maxMemoCharacters) : 0n;
    message.txSigLimit = (object.txSigLimit !== undefined && object.txSigLimit !== null) ? BigInt(object.txSigLimit) : 0n;
    message.txSizeCostPerByte = (object.txSizeCostPerByte !== undefined && object.txSizeCostPerByte !== null) ? BigInt(object.txSizeCostPerByte) : 0n;
    message.sigVerifyCostEd25519 = (object.sigVerifyCostEd25519 !== undefined && object.sigVerifyCostEd25519 !== null) ? BigInt(object.sigVerifyCostEd25519) : 0n;
    message.sigVerifyCostSecp256k1 = (object.sigVerifyCostSecp256k1 !== undefined && object.sigVerifyCostSecp256k1 !== null) ? BigInt(object.sigVerifyCostSecp256k1) : 0n;
    return message;
  },
};
