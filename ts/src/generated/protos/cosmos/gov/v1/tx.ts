...
> = {
  ...
  fromJSON(object: any): MsgCancelProposalResponse {
    return {
      ...
      canceledHeight: isSet(object.canceled_height) ? BigInt(object.canceled_height) : 0n,
    };
  },
  ...
  toJSON(message: MsgCancelProposalResponse): unknown {
    ...
    if (message.canceledHeight !== 0n) {
      obj.canceled_height = message.canceledHeight.toString();
    }
    return obj;
  },
  fromPartial(object: DeepPartial<MsgCancelProposalResponse>): MsgCancelProposalResponse {
    ...
    message.canceledHeight = (object.canceledHeight !== undefined && object.canceledHeight !== null) ? BigInt(object.canceledHeight) : 0n;
    return message;
  },
};
