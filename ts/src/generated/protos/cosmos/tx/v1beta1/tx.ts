...
export const TxBody: MessageFns<TxBody, "cosmos.tx.v1beta1.TxBody"> = {
  ...
  fromJSON(object: any): TxBody {
    return {
      ...
      timeoutHeight: isSet(object.timeout_height) ? BigInt(object.timeout_height) : 0n,
  ...
  toJSON(message: TxBody): unknown {
    ...
    if (message.timeoutHeight !== 0n) {
      obj.timeout_height = message.timeoutHeight.toString();
    }
    if (message.unordered !== false) {
  ...
  fromPartial(object: DeepPartial<TxBody>): TxBody {
    ...
    message.timeoutHeight = (object.timeoutHeight !== undefined && object.timeoutHeight !== null) ? BigInt(object.timeoutHeight) : 0n;
...
export const Fee: MessageFns<Fee, "cosmos.tx.v1beta1.Fee"> = {
  ...
  fromJSON(object: any): Fee {
    return {
      ...
      gasLimit: isSet(object.gas_limit) ? BigInt(object.gas_limit) : 0n,
  ...
  toJSON(message: Fee): unknown {
    ...
    if (message.gasLimit !== 0n) {
      obj.gas_limit = message.gasLimit.toString();
    }
    if (message.payer !== "") {
  ...
  fromPartial(object: DeepPartial<Fee>): Fee {
    ...
    message.gasLimit = (object.gasLimit !== undefined && object.gasLimit !== null) ? BigInt(object.gasLimit) : 0n;
