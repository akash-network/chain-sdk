module pkg.akt.dev/tools/generate-sdl-fixtures

go 1.25.0

require pkg.akt.dev/go/sdl v0.0.0-00010101000000-000000000000
...
require (
	...
	pkg.akt.dev/go v0.1.1 // indirect
