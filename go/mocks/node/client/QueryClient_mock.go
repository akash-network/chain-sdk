...
// QueryClient_Verification_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Verification'
type QueryClient_Verification_Call struct {
	*mock.Call
}

// Verification is a helper method to define mock.On call
func (_e *QueryClient_Expecter) Verification() *QueryClient_Verification_Call {
	return &QueryClient_Verification_Call{Call: _e.mock.On("Verification")}
}

func (_c *QueryClient_Verification_Call) Run(run func()) *QueryClient_Verification_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *QueryClient_Verification_Call) Return(_a0 verificationv1.QueryClient) *QueryClient_Verification_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *QueryClient_Verification_Call) RunAndReturn(run func() verificationv1.QueryClient) *QueryClient_Verification_Call {
	_c.Call.Return(run)
	return _c
}
