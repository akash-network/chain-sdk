...
// ProviderLeaseStats provides a mock function with given fields: ctx, in, opts
func (_m *QueryClient) ProviderLeaseStats(ctx context.Context, in *v1beta5.QueryProviderLeaseStatsRequest, opts ...grpc.CallOption) (*v1beta5.QueryProviderLeaseStatsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ProviderLeaseStats")
	}

	var r0 *v1beta5.QueryProviderLeaseStatsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta5.QueryProviderLeaseStatsRequest, ...grpc.CallOption) (*v1beta5.QueryProviderLeaseStatsResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta5.QueryProviderLeaseStatsRequest, ...grpc.CallOption) *v1beta5.QueryProviderLeaseStatsResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta5.QueryProviderLeaseStatsResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *v1beta5.QueryProviderLeaseStatsRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// QueryClient_ProviderLeaseStats_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ProviderLeaseStats'
type QueryClient_ProviderLeaseStats_Call struct {
	*mock.Call
}

// ProviderLeaseStats is a helper method to define mock.On call
//   - ctx context.Context
//   - in *v1beta5.QueryProviderLeaseStatsRequest
//   - opts ...grpc.CallOption
func (_e *QueryClient_Expecter) ProviderLeaseStats(ctx interface{}, in interface{}, opts ...interface{}) *QueryClient_ProviderLeaseStats_Call {
	return &QueryClient_ProviderLeaseStats_Call{Call: _e.mock.On("ProviderLeaseStats",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *QueryClient_ProviderLeaseStats_Call) Run(run func(ctx context.Context, in *v1beta5.QueryProviderLeaseStatsRequest, opts ...grpc.CallOption)) *QueryClient_ProviderLeaseStats_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*v1beta5.QueryProviderLeaseStatsRequest), variadicArgs...)
	})
	return _c
}

func (_c *QueryClient_ProviderLeaseStats_Call) Return(_a0 *v1beta5.QueryProviderLeaseStatsResponse, _a1 error) *QueryClient_ProviderLeaseStats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *QueryClient_ProviderLeaseStats_Call) RunAndReturn(run func(context.Context, *v1beta5.QueryProviderLeaseStatsRequest, ...grpc.CallOption) (*v1beta5.QueryProviderLeaseStatsResponse, error)) *QueryClient_ProviderLeaseStats_Call {
	_c.Call.Return(run)
	return _c
}
