...
type DepositParams struct {
	...
	MinInitialDepositRate github_com_cosmos_cosmos_sdk_types.LegacyDec `protobuf:"bytes,1,opt,name=min_initial_deposit_rate,json=minInitialDepositRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_initial_deposit_rate" yaml:"min_initial_deposit_rate"`
}
