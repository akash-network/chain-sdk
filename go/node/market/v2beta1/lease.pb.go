...
// source: akash/market/v2beta1/lease.proto
...
func (Lease_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5aee6c2f5a02dea2, []int{1, 0}
}
...
func (*LeaseID) Descriptor() ([]byte, []int) {
	return fileDescriptor_5aee6c2f5a02dea2, []int{0}
}
...
type Lease struct {
	...
	State Lease_State `protobuf:"varint,2,opt,name=state,proto3,enum=akash.market.v2beta1.Lease_State" json:"state" yaml:"state"`
	...
	Reason   LeaseClosedReason `protobuf:"varint,6,opt,name=reason,proto3,enum=akash.market.v2beta1.LeaseClosedReason" json:"reason" yaml:"reason"`
}

func (m *Lease) Reset()      { *m = Lease{} }
func (*Lease) ProtoMessage() {}
func (*Lease) Descriptor() ([]byte, []int) {
	return fileDescriptor_5aee6c2f5a02dea2, []int{1}
}
...
func (m *Lease) GetPrices() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.Prices
	}
	return nil
...
func init() {
	proto.RegisterEnum("akash.market.v2beta1.Lease_State", Lease_State_name, Lease_State_value)
	proto.RegisterType((*LeaseID)(nil), "akash.market.v2beta1.LeaseID")
	proto.RegisterType((*Lease)(nil), "akash.market.v2beta1.Lease")
}

func init() { proto.RegisterFile("akash/market/v2beta1/lease.proto", fileDescriptor_5aee6c2f5a02dea2) }

var fileDescriptor_5aee6c2f5a02dea2 = []byte{
	// 749 bytes of a gzipped FileDescriptorProto
	,
}
