...
func AddLeaseCloseReasonFlag(flags *pflag.FlagSet) {
	flags.Int32(FlagReason, 10001, "Numeric reason for closing the lease (0=invalid, 1=owner, 10000=unstable, 10001=decommission, 10002=unspecified, 10003=manifest_timeout, 20000=insufficient_funds)")
}
