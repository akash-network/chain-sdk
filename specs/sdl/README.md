...
`testdata/sdl/invalid/` — Both schema and Go parser reject
`testdata/sdl/schema-only-invalid/` — Schema rejects, Go parser accepts (stricter rules)
`testdata/sdl/v2.0/`, `v2.1/` — Valid fixtures for parity tests (Go ↔ TS output comparison)
